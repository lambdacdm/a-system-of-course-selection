#############################################################################
# Makefile for building: coursesystem
# Generated by qmake (3.1) (Qt 6.4.0)
# Project:  coursesystem\coursesystem.pro
# Template: app
# Command: C:\Qt\6.4.0\mingw_64\bin\qmake.exe -o Makefile coursesystem\coursesystem.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: coursesystem/coursesystem.pro C:/Qt/6.4.0/mingw_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.4.0/mingw_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile coursesystem\coursesystem.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
